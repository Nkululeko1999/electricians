  ...
  return (
    <>
        ...
        <div className="container about-container">
          <h2 className="about-heading text-center">About Us <hr className='decorator-line' /></h2>
          <div className="row">
            {/* First Row */}
          ...
          <div className='row about-info-container'>
            <div className="col-md-6">
              ...
              <p className='story'>
              Welcome to [Company Name], your premier destination for exceptional electrical and plumbing services in 
              [Location/City/Region]. With years of industry expertise, our skilled team delivers top-notch craftsmanship and 
              unparalleled customer satisfaction. From electrical repairs to plumbing installations, 
              we handle every project with precision and care. <br /> <br /> Our commitment to transparency ensures upfront pricing and honest 
              assessments, so you can trust us every step of the way. Safety is our priority, and we adhere to the highest industry 
              standards to deliver reliable, long-lasting results. Whether you're a homeowner, business owner, or property manager, 
              count on [Company Name] for all your electrical and plumbing needs.
              </p>
            </div>
            <div className="col-md-6">
